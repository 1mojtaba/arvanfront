 ...
 <section>
    ...
    <div class="w-64 h-screen bg-blue-600 text-white">
        ...
        <div class="list-none ml-9 mt-6 text-lg">
            <button onClick={getAriticles} class="block">All Articles</button>
            <button class="mt-7">New Article</button>
        </div>
    </div>
    <div>
...
<div class="relative shadow-md ml-7">
  ...
  <div>
    <button type="button" onClick={toggleDropDown} class="inline-flex text-white w-full justify-center gap-x-1.5 rounded-md bg-sky-400 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-sky-300" id="menu-button" aria-expanded="true" aria-haspopup="true">
      ...
  ...
  <div class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
    <div className={`${!openDropDown ? 'hidden' : ''}`} id="dropdown" role="none">
      <a href="#" class="no-underline text-gray-700 block px-4 py-2 text-sm text-black" role="menuitem" tabindex="-1" id="menu-item-0" onClick={handleEdit}>Edit</a>
